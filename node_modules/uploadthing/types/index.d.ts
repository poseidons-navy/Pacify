 ...
 */
interface FileUploadDataWithCustomId extends FileUploadData {
    /**
 ...
 */
interface UploadedFileData extends FileUploadDataWithCustomId {
    key: string;
    url: string;
}
/**
...
export type { ACLUpdateOptions, ClientUploadedFileData, DeleteFilesOptions, FileEsque, FileUploadData, FileUploadDataWithCustomId, GenerateUploaderOptions, GetFileUrlsOptions, GetSignedURLOptions, ListFilesOptions, RenameFileUpdate, UTApiOptions, UploadFileResult, UploadFilesOptions, UploadedFileData, UrlWithOverrides };
